...
exports.signup = async (req, res) => {
  try {
    const { firstName, lastName, email, password, studyingIn, gender, age, city, contactNumber, countryCode } = req.body;
    ...
    const newStudent = new Student({ firstName, lastName, email, password: hashedPassword, studyingIn, gender, age, city, contactNumber, countryCode });
